...
function TreatmentCard({ t }: { t: Treatment }) {
  return (
    <Link
      ...
      className="group relative overflow-hidden rounded-3xl bg-muted/40
    ...
    >
      ...
      {/* Bottom bar */}
      <div className="flex items-center justify-between gap-3 border-t border-foreground/8 bg-card p-5">
